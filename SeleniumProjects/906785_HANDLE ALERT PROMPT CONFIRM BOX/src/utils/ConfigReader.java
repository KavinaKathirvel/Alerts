...
public class ConfigReader {
	...
	public ConfigReader() {
		...
		try {
			...
			fs = new FileInputStream(path+"\\src\\utils\\Config.properties");
			
			//fs = new FileInputStream("G:\\CTS\\906785_HANDLE ALERT PROMPT CONFIRM BOX\\src\\utils\\Config.properties");
